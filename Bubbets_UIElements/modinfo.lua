...
meta =
{
    ...
    name = "Bubbets_UIElements",

    -- Title of your mod that will be displayed to players
    title = "Bubbet's UIElements",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "A collection of UIElements used in Bubbet's mods.",
    ...
    -- },
    dependencies = {
        {id = "2077819035", max = "1.0", optional = true},
        {id = "2130272263", max = "1.0", optional = true},
        {id = "Avorion", max = "1.3.*"}
    },
