...
meta =
{
    ...
    name = "SectorOverviewRanksAddon",

    -- Title of your mod that will be displayed to players
    title = "Sector Overview Ranks Addon",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Interfaces the Sector Overview mod with the Ranks mod",
    ...
    -- },
    dependencies = {
        {id = "1995604018", min = "1.0", optional = true},
        {id = "1722256729", min = "1.0", optional = true},
        {id = "2026618709", min = "1.0", optional = true},
        {id = "2028221361", min = "1.0", optional = true},
        {id = "Avorion", max = "1.0"}
    },
