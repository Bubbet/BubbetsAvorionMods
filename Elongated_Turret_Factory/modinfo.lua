...
meta =
{
    ...
    name = "Elongated Turret Factory",

    -- Title of your mod that will be displayed to players
    title = "Elongated Turret Factory",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "A expansion on the Extended Turret Factory mod. I took the time to get it ready for the workshop. It adds turret filtering, and sorting to aid you in finding the most optimal turret out of your seeds.",

    -- Insert all authors into this list
    authors = {"Bubbet!", "Valgrick", "Hammelpilaw", "douglasg14b", "Alopix"},
    ...
    -- },
    dependencies = {
        {id = "2003555597", max = "0.*", optional = true},
        {id = "1819397390", max = "0.*", optional = true},
        {id = "Avorion", max = "0.33.*", optional = true}
    },
