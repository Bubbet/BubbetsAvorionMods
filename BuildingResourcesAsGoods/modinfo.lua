...
meta =
{
    ...
    name = "BuildingResourcesAsGoods",

    -- Title of your mod that will be displayed to players
    title = "Building Resources As Goods",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This only really works in singleplayer, or atleast it doesn't work for alliances.",
