...
meta =
{
    ...
    name = "HyperspaceBlockItem",

    -- Title of your mod that will be displayed to players
    title = "Hyperspace Block Item",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Block the hyperspace of other players with a hyperspace jammer. Bought from equipment docks under utility tab.",
