...
meta =
{
    ...
    name = "Resource_Display_Ranks_Addon",

    -- Title of your mod that will be displayed to players
    title = "Resource Display Ranks Addon",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Interfacing Resource Display With Ranks Mod.",
    ...
    -- },
    dependencies = {
        {id = "1769379152", min = "1.0", optional = true},
