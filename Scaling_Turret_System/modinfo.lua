...
meta =
{
    ...
    name = "Scaling_Turret_System",

    -- Title of your mod that will be displayed to players
    title = "Scaling Turret System",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Uses your ships volume, hull, shield, etc to scale turret slots. Requires ConfigLoader to configure. Could also potentially be configured to scale other buffs.",
    ...
    -- },
    dependencies = {
        {id = "2003555597", min = "1.0"},
        {id = "Avorion", min = "0.33.5", max = "1.0.*"}
    },
