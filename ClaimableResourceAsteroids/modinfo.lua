...
meta =
{
    ...
    name = "ClaimableResourceAsteroids",

    -- Title of your mod that will be displayed to players
    title = "Claimable Resource Asteroids",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Claim resource asteroids and build mines on them to produce resources. Take the resources to resource depots to refine.",
    ...
    -- },
    dependencies = {
        {id = "1691539727", min = "*.*", optional = true},
        {id = "2003555597", min = "1.0", optional = true},
        {id = "2158516890", max = "*.*", optional = true},
        {id = "Avorion", max = "1.3.*"}
    },
